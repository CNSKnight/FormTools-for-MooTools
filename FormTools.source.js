(function (root, factory) {
        if (typeof define === 'function' && define.amd) {
            // AMD
            define(['mootools'], factory);
        } else if (typeof exports === 'object') {
            // Node, CommonJS-like
            module.exports = factory(require('mootools'));
        } else {
            // Browser globals (root is window)
            root.FormTools = factory();
        }
}(this, function () {
        var $ = $ || document.id
        ...
        * Assertions are implemented into FormTools simply to have them easier to manage
        ...
        */
        Assertions = new Class ({
                failureMessages: {
                    ...
                    isNotValuesMatchIfNotIsValueEmpty: 'These values should match or left unchanged',
                    ...
                    */
                    isNotValuesMatch: function(elem, assertObj) {
                        ...
                        if (result) {
                            ...
                            this.lastFailureMsg = 
                            '<dl><dt>'+legend+'</dt><dd>'+ this.lastFailureMsg + '</dd></dl>';
                    ...
                    */
                    ...
                    isNotOneTrue: function(elem, assertObj) {
                        ...
                        if (trueCnt !== 1) {
                            ...
                            this.lastFailureMsg = 
                            '<dl><dt>'+legend+'</dt><dd>'+ this.lastFailureMsg + '</dd></div>';
        ...
        * 	     };
        * 
        *       myLib.runFormChecks(this, fieldChecks);
        * </script>
        ...
        */
        FormTools = new Class({
                ...
                options: {
                    ...
                    useDialog: false,
                    successBlocClass: 'bg-success',
                    successTextClass: 'text-success',
                    errorBlocClass: 'bg-danger',
                    errorTextClass: 'text-danger',
                    msgTemplate: '<p><span class="%s">%s</span> %s</p>',
                    
                    // status indication
                    submitElem: '.btn[type="submit"]',
                    elemParentSlctr: '.form-group',
                    elemParentErrorClass: 'has-error',
                    elemParentSuccessClass: 'has-success',
                ...
                initElemParentClass: function() {
                    this.labels = this.chkForm.getElements('label');
                    this.labels && this.labels.each(function(elem) {
                            var parent = elem.getParent(this.options.elemParentSlctr);
                            parent && parent.addClass(this.options.elemParentSuccessClass);
                    }.bind(this));
                },
                ...
                setInfoDiv: function() {
                    if (! this.options.infoDiv) {
                        ...
                        this.infoDiv = new Element('div', {styles:{display:'none'}})
                        .grab(new Element('fieldset').grab(new Element('legend', {text: 'InfoDiv'})));
                ...
                // this runs on run just prior to processFieldChks
                initInfoDiv: function() {
                    ...
                    if (this.options.useInfoDivCloser) {
                        ...
                        this.infoDiv.grab(new Element('fieldset', {'class': 'ft-msg-bloc'})
                            .grab(new Element('legend', {text: 'Form Process Information:'}))
                            .grab( new Element('p', {text: 'Now checking your form values... :D', 'class': this.options.successBlocClass}))
                            );
                    }
                    
                    if (pos == 'fixed' || pos == 'absolute') {
                        this.infoDiv.fade('out').removeClass('dispNo').setStyle('display', 'block').fade('in');
                    }
                },
                ...
                */
                ...
                setLastFailureMsg: function(labelText, msgText) {
                    this.lastFailureMsg += sprintf(this.options.msgTemplate, this.options.errorTextClass, labelText, msgText);
                },
                /**
                ...
                */
                ...
                processFailure: function(elem, assertionName, label) {
                    ...
                    $(elem).getParent(this.options.elemParentSlctr).addClass(this.options.elemParentErrorClass);
                },
                ...
                onFailures: function() {
                    ...
                    .grab(new Element('div', {'class': this.options.errorBlocClass, html: this.failureMsgPool}))
                    .grab(new Element('legend', {text: 'Errors in Form:'}), 'top');
                    
                    var pos = this.infoDiv.getStyle('position');
                    
                    if (pos == 'fixed' || pos == 'absolute') {
                        if (this.infoDiv.setPos) {
                            this.infoDiv.setPos();
                        }
                ...
                onSuccess: function() {
                    ...
                    .grab(new Element('p', {text: 'All values checked ok.', 'class': this.options.successTextClass}))
                    .removeClass(this.options.errorBlocClass).addClass(this.options.successBlocClass);
